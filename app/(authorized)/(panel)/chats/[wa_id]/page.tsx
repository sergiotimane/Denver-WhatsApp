...
export default function ContactChat({ params }: { params: { wa_id: string } }) {
	...
	const setContactTab = useSetContactTab(false);
												...
												return (
													<div className='p-4 bg-white flex flex-row gap-4 items-center'>
														<span className='text-sm'>
															...
															<a className='text-blue-500' href='https://developers.facebook.com/docs/whatsapp/cloud-api/guides/send-messages#customer-service-windows' target='_blank' rel='noopener noreferrer'>
																Read more
															</a>
														</span>
														<TemplateSelection onTemplateSubmit={onTemplateSubmit}>
															<Button disabled={messageTemplateSending} className='min-w-fit'>
																{messageTemplateSending && (
																	<>
